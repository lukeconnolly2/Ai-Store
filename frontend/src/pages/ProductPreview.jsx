...
export const ProductPreview = (props) => {
  ...
  return (
        <div className="text-slate-900 bg-primary h-[20vh] col-span-2 translate-x-0 duration-300 border-black border-y-2 m-y-auto flex flex-row hover:h-[50vh place-items-center justify-evenly rounded-md"> 
            <div className="h-auto max-w-xs object-contain p-3 basis-5/12"> <img className="h-[17vh] w-fit rounded-sm" src={productImgUrl ? productImgUrl : placeholderImgUrl} /> </div>
            ...
            <div className="basis-1/12 text-3xl" >
              <svg onClick={() => {removeFromCart(id)}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 scale-150 cursor-pointer">
